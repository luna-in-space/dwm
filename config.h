...
static const unsigned int gappx     = 40;        /* gaps size between windows */
...
static const char col_cyan[]        = "#8652ff";
...
//sets kitty as the default terminal
static const char *termcmd[]  = { "kitty", NULL };
static const char *browser[]  = { "firefox", NULL };
static const char *messaging[]  = { "discord", NULL };
//volume controls
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
        { MODKEY,			XK_e,      spawn,          SHCMD("~/scripts/emoji.sh") },
	{ MODKEY,	                XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY,                       XK_f,      spawn,          {.v = browser } },                
	{ MODKEY,                       XK_d,      spawn,          {.v = messaging } },
